<?php
error_reporting(0);
$url = "http://world5.commonsupport.com/html/volunteer/";
$objeto = $_GET['pg'];
...
curl_close($ch);
		...
		$arquivo_ajustado = str_replace($url,'./',$arqq);
		$arquivo_ajustado = str_replace('https://winmove.app/rental/','/site/',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('google-analytics','',$arquivo_ajustado);
		
		$arquivo_ajustado = str_replace('//winmove.app/rental/','/site/',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('https://winmove.app/','/site/',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('//winmove.app/','/site/',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('google-site-verification','site-ver',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('https:','',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('http:','',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('googletagmanager','google',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('//winmove.app/','/site/',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('agencia-do-site','/site/',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('//winmove.app/','GOCOMUNICA',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('(11) 3199-0000','(11) 4040-9537',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('//winmove.app/rental/','/site/',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('11 3199-0000','11 4040-9537',$arquivo_ajustado);
...
curl_close($ch);
		...
		$arquivo_ajustado = str_replace('https://winmove.app/rental/','gocomunica.com',$arqq);
		$arquivo_ajustado = str_replace('https://winmove.app/rental/','gocomunica.com',$arquivo_ajustado);
		$arquivo_ajustado = str_replace('google-analytics','',$arquivo_ajustado);
		...
		if(!preg_match('//site/',$anterior.$arquivo[0])){
...
curl_close($ch);
		...
		if(!preg_match('//site/',$anterior.$c_objeto[$i])){

		if($arquivo_ajustado!=''){

		if(!file_exists($anterior.$c_objeto[$i].'/default.htm')){

		if(!preg_match('/.ttf/',$anterior.$c_objeto[$i]) AND !preg_match('/.woff/',$anterior.$c_objeto[$i]) AND !preg_match('/.svg/',$anterior.$c_objeto[$i]) AND !preg_match('/.jpg/',$anterior.$c_objeto[$i]) AND !preg_match('/.gif/',$anterior.$c_objeto[$i]) AND !preg_match('/.png/',$anterior.$c_objeto[$i]) AND !preg_match('/.bmp/',$anterior.$c_objeto[$i]) AND !preg_match('/.jpeg/',$anterior.$c_objeto[$i]) AND !preg_match('/.rar/',$anterior.$c_objeto[$i]) AND !preg_match('/.zip/',$anterior.$c_objeto[$i]) AND !preg_match('/.exe/',$anterior.$c_objeto[$i]) AND !preg_match('/.dll/',$anterior.$c_objeto[$i]) AND !preg_match('/.eot/',$anterior.$c_objeto[$i])){
