...
<div class="page-wrapper">
    ...
    <div class="bread-crumb">
       ...
       <a href="causas.php">Causas  &ensp;<span class="fa fa-angle-right"></span>&ensp; <a href="#" class="ative">Autismo</a>
        </div>
    </div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 pull-right">
                    <section class="blog-section">
                        ...
                        <div class="blog-post wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <article class="column-inner">
                                <figure class="image-box">
                                    <a href="#"><img src="images/resource/aut1.jpg" alt="" title="Blog"></a>
                        ...
                        <div class="blog-post wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <article class="column-inner">
                            <figure class="image-box">
                                    <a href="#"><img src="images/resource/aut2.jpg" alt="" title="Blog"></a>
                                    <div class="post-options">
                                    	<a href="#" class="plus-icon img-circle"><span class="flaticon-add30"></span></a>
                                        <a href="#" class="heart-icon img-circle"><span class="flaticon-favorite21"></span></a>
                                    </div>
                        ...
                        <div class="blog-post wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <article class="column-inner">
                                <figure class="image-box">
                                    <a href="#"><img src="images/resource/aut3.jpg" alt="" title="Blog"></a>
                                    <div class="post-options">
                                    	<a href="#" class="plus-icon img-circle"><span class="flaticon-add30"></span></a>
                                        <a href="#" class="heart-icon img-circle"><span class="flaticon-favorite21"></span></a>
                                    </div>
