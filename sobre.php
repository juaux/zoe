...
<!--Header Lower End-->
    ...
    <div class="bread-crumb">
    	<div class="auto-container">
        	  &ensp;<span class="fa fa-angle-right"></span>&ensp; <a href="#" class="ative">Sobre Nós</a>
        </div>
    </div>
    ...
    <section class="four-column team-section extended no-padd-top">
    	<div class="auto-container">
        	<div class="sec-title">
                <h2>Nosso grupo de <strong>voluntários</strong></h2>
            </div>
    ...
    <section class="parallax-section" style="background-image:url(images/parallax/image-1.jpg);">
    	<div class="auto-container">
        	<div class="text-center wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            	<h2>Você está pronto para ser voluntário?</h2>
                <h3>comece uma de nossas causas hoje e ajude pessoas necessitadas</h3>
                <div class="line"></div>
                <a class="theme-btn light-btn" href="#">SEJA UM VOLUNTÁRIO</a>
                <a class="theme-btn light-btn" href="#">FAÇA UMA DOAÇÃO</a>
