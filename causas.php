...
<div class="page-wrapper">
    ...
    <section class="four-column current-projects no-padd-top">
        <div class="auto-container">
            <div class="sec-title clearfix">
                <h2 class="pull-left">Nossos <strong>projetos</strong></h2>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="cursos.php"><img src="images/resource/cursos.png" alt="" title="Volunteer"></a>
                        </figure>
                        <div class="lower-part">
                            <div class="text">
                                <h3>Cursos para Crianças e Jovens</h3>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="depressao.php"><img src="images/resource/depressao.jpg" alt="" title="Volunteer"></a>

                        </figure>
                        <div class="lower-part">
                            <div class="text">
                                <h3>Ajuda para Depressão</h3>
                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                            </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="violencia.php"><img src="images/resource/violencia.jpg" alt="" title="Volunteer"></a>

                        </figure>
                        <div class="lower-part">
                            <div class="text">
                                <h3>Combate a violencia doméstica</h3>
                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                            </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="900ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="autismo.php"><img src="images/resource/autismo.jpg" alt="" title="Volunteer"></a>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="cpobreza.php"><img src="images/resource/pobreza.jpg" alt="" title="Volunteer"></a>

                        </figure>
                        <div class="lower-part">
                            <div class="text">
                                <h3>Combate a pobreza</h3>
                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                            </div>
    ...
    <section class="help-us" style="background-image:url(images/background/helpus-bg.jpg);">
        <div class="auto-container">
            <h2>Como voce pode nos ajudar?</h2>
            <div class="row clearfix">
