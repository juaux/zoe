<?php
    ...
    if(isset($_POST['id'])){
        ...
        $stmt->bind_param("sssssssssssssssssssss", $nome, $telefone, $email, $data_nasc, $cpf, $cep, $endereco, $bairro, $numero, $cidade, $estado, $uf, $sexo, $curso, $formacao, $data_entrada, $foto, $id);
